...
class Editor:
    ...
    def toggle_selection(self):
        ...
        if self.selection_manager.is_selecting:
            ...
            self.message = "Selection ended"
        else:
            self.selection_manager.start_selection(self.cursor.row, self.cursor.col)
            self.message = "Selection started"
    
    def select_all(self):
        """Select all text"""
        self.selection_manager.select_all(self.text_buffer)
        self.message = "All text selected"
    
    def copy_selection(self):
        """Copy selected text to clipboard"""
        if self.selection_manager.has_selection():
            bounds = self.selection_manager.get_selection_bounds()
    ...
    def run(self):
        ...
        while self.running:
            try:
                ...
                # Render everything
                self.display.render_all(self.text_buffer, self.cursor, self.selection_manager)
